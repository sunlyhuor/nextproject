...
export default function AlertComponent({alert , changeAlert}){

    useCallback

    return(
        <> 
            <div className={alert ? "w-full h-screen absolute bg-black opacity-20 top-0 left-0 z-[10]  " : ""} ></div>
            <div className={alert ? "w-full h-screen absolute top-0 left-0 flex justify-center flex-col items-center " : ""} >
                <div id="alert-additional-content-5" className={ `z-[15] w-6/12 p-4 border border-gray-300 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-800 relative ${alert ? "block" : "hidden" } ` } role="alert">
