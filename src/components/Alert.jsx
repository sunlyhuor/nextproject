...
export default function AlertComponent({alert , changeAlert}){
    ...
    return(
        <> 
            <h1>Alert : { alert.toString() } </h1> 
            <div id="alert-additional-content-5" className={ `p-4 border border-gray-300 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-800 ${alert ? "block" : "hidden" } ` } role="alert">
